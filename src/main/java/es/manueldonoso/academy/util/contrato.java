...
public class contrato {
    ...
    private static String contrato="Contrato de Licencia de Uso de Software\n" +
"\n" +
"Entre " +
"Manuel Jesús Donoso Pérez, con página web www.manueldonoso.es y correo de contacto dev@manueldonoso.es (en adelante, \"el Propietario\")" +
" y " +
"El usuario final del software "+UsuarioFinal+"  (en adelante, \"el Usuario\").\n" +
"\n" +
"OBJETO DEL CONTRATO\n\n" +
...
"dev@manueldonoso.es";
    ...
    public static void setUsuarioFinal(String usuarioFinal) {
